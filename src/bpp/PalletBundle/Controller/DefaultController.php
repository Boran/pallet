...
class DefaultController extends Controller
{
    ...
    public function indexAction(Request $request, $name)
    {
        ...
        //@todo: create a form with default value
        ...
        $form = $this->createFormBuilder($pallet)
            ...
            ->add('layout', 'choice', array(
                    'choices' => array('versq'=>'Vertical square', 'verint'=>'Vertical interleaved'),
                    'required' => true,
                ))
            ->add('threed', 'text')
        ...
        if ($form->isValid()) {
            ...
            return new Response("Pallet: layout= " . $pallet->layout) ;
        }
...
//----------------------
    ...
    {
        $this->debug1(" rollwidth=$$pallet->rollwidth_mm diam=$pallet->diam_mm rows=$pallet->rows");
        //$this->debug1("mm per pixel: pscalex=$pscalex pscaley=$pscaley");
        //$this->debug1("pallet mm: $pwidth_mm x $plength_mm");
    }
}
